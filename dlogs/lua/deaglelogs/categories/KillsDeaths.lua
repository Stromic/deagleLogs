...
local CATEGORY = {}
CATEGORY.Name = "Kills/Deaths"
CATEGORY.RawName = "Kills"
CATEGORY.Order = 5
CATEGORY.Data = {}
CATEGORY.Pages =1;
CATEGORY.MaxPages=1;
--CATEGORY.Disabled = 1
CATEGORY.Query = "time varchar(255), steam_id varchar(255), steam_name varchar(255), name varchar(255), ip_address varchar(255),steam_id_killer varchar(255), steam_name_killer varchar(255), name_killer varchar(255), ip_address_killer varchar(255), weapon varchar(255)"
CATEGORY.SearchVars = {
["Victim ID"] = {val="steam_id",ex="[Example] STEAM_0:1:32634764",default=true},
["Victim Name"] = {val="name",ex="[Example] Neo Bowden"},
["Victim IP"] = {val="ip_address",ex="[Example] 192.1.1.254"},
["Killer ID"] = {val="steam_id_killer",ex="[Example] STEAM_0:1:32634764"},
["Killer Name"] = {val="name_killer",ex="[Example] Neo Bowden"},
["Killer IP"] = {val="ip_address_killer",ex="[Example] 192.1.1.254"},
["Weapon"] = {val="weapon",ex="[Example] weapon_zm_ak47"},
}
...
function CATEGORY.FillData()
	...
	for k,v in pairs(CATEGORY.Data) do
		...
		if dLogs.version != "JB" then
			log = Format([[%s(%s) killed %s(%s) with %s]],v.name_killer,v.role_killer,v.name,v.role,v.weapon)
		else
			log = Format([[%s(%s) killed %s(%s) with %s]],v.name_killer,v.role_killer,v.name,v.role,v.weapon)
		end
